const new_form = document.querySelector(".js-new_form");
...
function renderText() {
  ...
  arr.forEach((item, index) => {
    ...
    clone.querySelector(".js-new_paragraph").textContent = `${index + 1}. ${item}`;
    clone.querySelector(".js-new_button").addEventListener("click", (evt) => {
      evt.preventDefault();
